...
function output = BowChain_master(Prefix,Deployment_name,TCn_DATA_Path,TCn_GPS_Path)
...
config = get_config(Prefix,Deployment_name,TCn_DATA_Path,TCn_GPS_Path); % get processing options
...
for i = 1:length(config)
    ...
    gridded(i).depth = -gridded(i).depth;    
